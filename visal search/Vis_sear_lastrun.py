...
expName = 'Vis_sear'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91932\\Desktop\\Monsoon 2025\\Lab\\visal search\\Vis_sear_lastrun.py',
